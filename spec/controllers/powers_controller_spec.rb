...
describe PowersController do
  ...
  # PowersController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested power as @power" do
      power = Power.create! valid_attributes
      get :show, {:id => power.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested power as @power" do
      power = Power.create! valid_attributes
      get :edit, {:id => power.to_param}, valid_session
      assigns(:power).should eq(power)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Power" do
        expect {
          post :create, {:power => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved power as @power" do
        ...
        post :create, {:power => {}}, valid_session
        assigns(:power).should be_a_new(Power)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested power" do
        ...
        put :update, {:id => power.to_param, :power => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested power as @power" do
        power = Power.create! valid_attributes
        put :update, {:id => power.to_param, :power => valid_attributes}, valid_session
        assigns(:power).should eq(power)
      end
    ...
    describe "with invalid params" do
      it "assigns the power as @power" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Power.any_instance.stub(:save).and_return(false)
        put :update, {:id => power.to_param, :power => {}}, valid_session
        assigns(:power).should eq(power)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested power" do
      power = Power.create! valid_attributes
      expect {
        delete :destroy, {:id => power.to_param}, valid_session
      }.to change(Power, :count).by(-1)
    end
